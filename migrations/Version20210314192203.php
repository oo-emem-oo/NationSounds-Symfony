 ...
 */
final class Version20210314192203 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE concerts (id INT AUTO_INCREMENT NOT NULL, scene_id INT, filename VARCHAR(255) , artiste VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, jour VARCHAR(255) NOT NULL, heure TIME NOT NULL, UNIQUE INDEX UNIQ_730600F1166053B4 (scene_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
